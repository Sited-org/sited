...
export default function AdminLayout() {
  ...
  return (
    <div className="h-screen bg-background flex overflow-hidden max-w-full">
      ...
      {/* Main content */}
      <main className="flex-1 min-w-0 min-h-0 overflow-hidden flex flex-col max-w-full">
        {/* Mobile header */}
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overflow-x-auto p-6 lg:p-8 bg-background">
          <Outlet />
        </div>
      </main>
    </div>
