...
import { ArrowLeft, Save, User, FolderOpen, CreditCard, Settings, Wallet, MessageSquare, BarChart3 } from 'lucide-react';
...
import { MetricsTab } from '@/components/admin/lead-profile/MetricsTab';
    ...
    <div className="space-y-6 max-w-6xl">
      ...
      <Tabs defaultValue="profile" className="w-full">
        ...
        <TabsContent value="metrics" className="mt-6">
          <MetricsTab lead={lead} />
        </TabsContent>

        <TabsContent value="requests" className="mt-6">
          <RequestsTab leadId={id!} />
        </TabsContent>
